...
#define TOKEN_QUERY     "/bin/busybox POSXY"
#define TOKEN_RESPONSE  "POSXY: applet not found"

#define EXEC_QUERY     "/bin/busybox DFDFX"
#define EXEC_RESPONSE  "DFDFX: applet not found"

#define FN_DROPPER  "3002f"
#define FN_BINARY   ".3002"
